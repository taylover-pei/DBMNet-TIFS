...
def train():
    ...
    for iter_num in range(max_iter+1):
        ...
        input_data = torch.cat([src1_img_real, src2_img_real, src3_img_real, src1_img_fake, src2_img_fake, src3_img_fake], dim=0)
        ...
        feature_real = feature.narrow(0, 0, input1_real_shape+input2_real_shape+input3_real_shape)
        ...
        source_domain_label = torch.cat([real_domain_label_1, real_domain_label_2, real_domain_label_3,
                                         fake_domain_label_1, fake_domain_label_2, fake_domain_label_3], dim=0).view(-1)
        ...
        total_loss = 1 * cls_loss + 1 * triplet + 1 * real_adloss 
        total_loss.backward()
        optimizer.step()
        optimizer.zero_grad()
