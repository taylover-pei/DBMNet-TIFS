...
def train():
    ...
    dev_dataloader, tgt_dataloader, src1_valid_dataloader, src2_valid_dataloader, src3_valid_dataloader, src4_valid_dataloader = get_dataset()
    ...
    src4_valid_iter = iter(src4_valid_dataloader)
    ...
    src4_valid, src4_valid_label, _, _ = src4_valid_iter.next()
    src4_valid = src4_valid.cuda()
    src4_valid_label = src4_valid_label.cuda()
    ...
    if(len(config.gpus) > 1):
        net.feature_generator = torch.nn.DataParallel(net.feature_generator).cuda()
    ...
    for iter_num in range(max_iter+1):
        ...
        domain_valid_list = [src1_valid, src2_valid, src3_valid, src4_valid]
        domain_valid_label_list = [src1_valid_label, src2_valid_label, src3_valid_label, src4_valid_label]
