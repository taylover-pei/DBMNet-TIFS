...
def get_dataset():
    ...
    src4_validation = sample_valid_frames(num_frames=1, dataset_name=config.src4_data)
    ...
    src4_valid_dataloader = DataLoader(YunpeiDataset(src4_validation, train=False), batch_size=60, shuffle=False)
    ...
    return src1_train_dataloader_fake, src1_train_dataloader_real, \
           ...
           dev_dataloader, tgt_dataloader, src1_valid_dataloader, src2_valid_dataloader, src3_valid_dataloader, src4_valid_dataloader
